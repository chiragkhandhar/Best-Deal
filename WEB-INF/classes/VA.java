...
public class VA extends HttpServlet {
	...
	/* VA Page Displays all the Voice Assitants and their Information in Best Deal*/
	...
	protected void doGet(HttpServletRequest request,
		...
		/* Checks the VA type whether it is microsft or Dell or Microsoft then add products to hashmap*/
		...
		All the vas and Tv information are dispalyed in the Content Section
		...
		for(Map.Entry<String, VAType> entry : hm.entrySet()){
			VAType va = entry.getValue();
